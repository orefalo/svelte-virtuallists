import{p as h,J as m,j,t as u,h as e,k as i,m as g,r as d,K as v,l as x,y}from"../chunks/external.B2XIb3UX.js";import{E as f}from"../chunks/ExampleArea.DauRvbGK.js";import{V as w}from"../chunks/svelte-virtuallists.C5xEC3WX.js";var L=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function V(t,s){h(s,!1);const n=new Array(1e4).fill(1).map((r,a)=>({text:"ITEM "+a+" - Item "+a}));m(),w(t,{items:n,style:"height:600px",vl_slot:(a,l)=>{let o=()=>l==null?void 0:l().item;var p=L(),c=g(p);d(p),u(()=>v(c,o().text)),e(a,p)},$$slots:{vl_slot:!0}}),j()}const _=`<script lang="ts">
