...
`,Vs={code:Ms,highlightedHTML:Rs,component:Ls};var Cs=C("<h2>Positioning</h2> <p>The component provides properties to position the list either on an element, or at a pixel offset.</p> <!>",1);function Us(u){var r=Cs(),p=n(rs(r),4);Ts(p,{example:Vs}),V(u,r)}export{Us as component,Hs as universal};
