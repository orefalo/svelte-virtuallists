import{I as bs,p as _s,b as i,s as c,u as es,m as rs,g as t,t as ps,O as os,P as cs,f as V,h as ys,j as C,k as e,q as n,w as a,Q as is,y as l,z as xs,R as zs,H as R}from"../chunks/external.DBvdoJEE.js";import{E as Ts}from"../chunks/ExampleArea.CVL16lgx.js";import{A as Ss,S as qs,V as ws}from"../chunks/svelte-virtuallists.x_EziPhy.js";const ks=!0,Hs=Object.freeze(Object.defineProperty({__proto__:null,prerender:ks},Symbol.toStringTag,{value:"Module"}));function Os(u,r){for(let p=0;p<10;(p+=1)-1)r.pop()}var Is=C('<div class="svelte-1bng65z"> </div>'),As=C('<div class="actions"><div class="select"><span>Scroll to row index <input id="index" type="number" placeholder="pick an index..." class="input"></span></div> <div class="select"><span>Scroll to pixel offset <input id="offset" type="number" placeholder="pick an offset..." class="input"></span></div> <div class="select"><span>Alignment <select id="alignment"><option>auto</option><option>start</option><option>center</option><option>end</option></select></span></div> <div class="select"><span>Behaviour <select id="behaviour"><option>auto</option><option>smooth</option><option>instant</option></select></span></div></div> <div style="font-weight: bold"><span>Visible Area: start</span> <span> </span> - <span>end</span> <span> </span></div> <!> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button> <button class="button">Randomize content</button> <button class="button">array size -10</button></div>',1);function Ms(u,r){_s(r,!0);const p=i(new Array(1e4));let B=c(0),E=c(0),g=c(void 0),m=c(void 0),j=c(void 0),f=c(void 0),v=c(i(Ss.AUTO)),b=c(i(qs.SMOOTH)),_=c(void 0),d;function hs(s){e(B,i(s.start)),e(E,i(s.end))}es(()=>{e(j,void 0),e(f,i(t(m)))}),es(()=>{e(f,void 0),e(j,i(t(g)))});function us(){d=new Array(p.length);for(let s=0;s<d.length;(s+=1)-1)d[s]=Math.round(Math.random()*65+30);e(_,(s,ls)=>d[s])}function N(){e(_,()=>25)}function H(){for(let s=0;s<p.length;(s+=1)-1)p[s]={text:Math.floor(Math.random()*p.length)}}H(),N();var U=As(),y=rs(U),x=a(y),G=a(x),$=n(a(G));is($),l(G),l(x);var z=n(x,2),P=a(z),Q=n(a(P));is(Q),l(P),l(z);var T=n(z,2),D=a(T),S=n(a(D)),q=a(S);q.value=(q.__value="auto")==null?"":"auto";var w=n(q);w.value=(w.__value="start")==null?"":"start";var k=n(w);k.value=(k.__value="center")==null?"":"center";var F=n(k);F.value=(F.__value="end")==null?"":"end",l(S),l(D),l(T);var J=n(T,2),K=a(J),O=n(a(K)),I=a(O);I.value=(I.__value="auto")==null?"":"auto";var A=n(I);A.value=(A.__value="smooth")==null?"":"smooth";var W=n(A);W.value=(W.__value="instant")==null?"":"instant",l(O),l(K),l(J),l(y);var M=n(y,2),L=n(a(M),2),js=a(L);l(L);var X=n(L,4),ds=a(X);l(X),l(M);var Y=n(M,2);ws(Y,{get items(){return p},style:"height:500px",get scrollToIndex(){return t(j)},get scrollToOffset(){return t(f)},get scrollToAlignment(){return t(v)},get scrollToBehaviour(){return t(b)},get sizingCalculator(){return t(_)},onVisibleRangeUpdate:hs,vl_slot:(ls,o)=>{let ts=()=>o==null?void 0:o().index,ms=()=>o==null?void 0:o().item,fs=()=>o==null?void 0:o().size;var h=Is(),vs=a(h);l(h),ps(()=>{xs(h,"style",`border: 1px solid rgb(204, 204, 204); line-height: ${fs()??""}px;`),zs(h,"highlighted",ts()===t(j)),R(vs,`#${ts()??""}
      ${ms().text??""}`)}),V(ls,h)},$$slots:{vl_slot:!0}});var Z=n(Y,2),ss=a(Z);ss.__click=us;var ns=n(ss,2);ns.__click=N;var as=n(ns,2);as.__click=H;var gs=n(as,2);gs.__click=[Os,p],l(Z),ps(()=>{R(js,t(B)),R(ds,t(E))}),os($,()=>t(g),s=>e(g,s)),os(Q,()=>t(m),s=>e(m,s)),cs(S,()=>t(v),s=>e(v,s)),cs(O,()=>t(b),s=>e(b,s)),V(u,U),ys()}bs(["click"]);const Ls=`<script lang="ts">
...
`,Vs={code:Ls,highlightedHTML:Rs,component:Ms};var Cs=C("<h2>Positioning</h2> <p>The component provides properties to position the list either on an element, or at a pixel offset.</p> <!>",1);function Us(u){var r=Cs(),p=n(rs(r),4);Ts(p,{example:Vs}),V(u,r)}export{Us as component,Hs as universal};
