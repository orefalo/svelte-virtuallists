import{L as C,p as R,q as t,v as L,g as _,f as i,h as H,k,j as o,s as A,t as b,y as m,A as d,B as S,K as w}from"../chunks/external.XVS9OJZd.js";import{E as F}from"../chunks/ExampleArea.HLz-Ok4E.js";import{V}from"../chunks/svelte-virtuallists.CHV1n25C.js";import{g as E}from"../chunks/sushi.BIpvo6ML.js";function B(l,n){k(n,()=>25)}var K=o("<div> </div>"),N=o("<div> </div>"),T=o('<h2>Horizontal</h2> <!> <h2>Vertical</h2> <!> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button></div>',1);function D(l,n){R(n,!0);const p=new Array(1e4).fill(1).map(()=>({text:E()}));function g(){k(e,()=>Math.round(Math.random()*125+30))}let e=A(void 0);g();var v=T(),x=t(L(v),2);V(x,{items:p,style:"width:100%",isHorizontal:!0,get sizingCalculator(){return _(e)},vl_slot:(c,s)=>{let r=()=>s==null?void 0:s().index,h=()=>s==null?void 0:s().item,u=()=>s==null?void 0:s().size;var a=K(),j=m(a);d(a),b(()=>{S(a,"style",`border: 1px solid rgb(204, 204, 204); width: ${u()??""}px;`),w(j,`#${r()??""}
      ${h().text??""}`)}),i(c,a)},$$slots:{vl_slot:!0}});var y=t(x,4);V(y,{items:p,style:"height:600px",get sizingCalculator(){return _(e)},vl_slot:(c,s)=>{let r=()=>s==null?void 0:s().index,h=()=>s==null?void 0:s().item,u=()=>s==null?void 0:s().size;var a=N(),j=m(a);d(a),b(()=>{S(a,"style",`border: 1px solid rgb(204, 204, 204); line-height: ${u()??""}px;`),w(j,`#${r()??""}
      ${h().text??""}`)}),i(c,a)},$$slots:{vl_slot:!0}});var z=t(y,2),f=m(z);f.__click=g;var M=t(f,2);M.__click=[B,e],d(z),i(l,v),H()}C(["click"]);const G=`<script lang="ts">
...
`,I=`<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">lang</span>=<span class="hljs-string">&quot;ts&quot;</span>&gt;</span><span class="language-javascript">
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`,J={code:G,highlightedHTML:I,component:D};var O=o("<h2>Variable item Sizing</h2> <!>",1);function X(l){var n=O(),p=t(L(n),2);F(p,{example:J}),i(l,n)}export{X as component};
