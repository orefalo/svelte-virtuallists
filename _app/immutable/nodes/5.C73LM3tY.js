...
`,Rs={code:Ms,highlightedHTML:Ls,component:As};var Vs=C("<h2>Positioning</h2> <p>The component provides properties to position the list either on an element, or at a pixel offset.</p> <!>",1);function Ns(u){var r=Vs(),p=n(rs(r),4);Ts(p,{example:Rs}),V(u,r)}export{Ns as component};
