import{N as gs,p as ms,s as e,b as c,u as ns,y as os,e as vs,g as t,t as ls,O as ts,P as ps,h as V,j as fs,d as p,k as B,l as s,m as a,Q as es,r as n,v as bs,R as _s,K as z}from"../chunks/external.ClML6rh5.js";import{E as ys}from"../chunks/ExampleArea.DqjhyFIj.js";import{A as ws,S as xs,V as qs}from"../chunks/svelte-virtuallists.Cbo0UehG.js";const Ts=!0,Bs=Object.freeze(Object.defineProperty({__proto__:null,prerender:Ts},Symbol.toStringTag,{value:"Module"}));function ks(j,i){p(i,50)}var Ss=B('<div class="row svelte-ufwu3t"> </div>'),Os=B('<div class="actions"><div class="select"><span>Scroll to row index <input id="index" type="number" placeholder="pick an index..." class="input"></span></div> <div class="select"><span>Scroll to pixel offset <input id="offset" type="number" placeholder="pick an offset..." class="input"></span></div> <div class="select"><span>Alignment <select id="alignment"><option>auto</option><option>start</option><option>center</option><option>end</option></select></span></div> <div class="select"><span>Behaviour <select id="behaviour"><option>auto</option><option>smooth</option><option>instant</option></select></span></div></div> <div style="float: right;font-weight: bold"><span>Visible Area: start</span> <span> </span> - <span>end</span> <span> </span></div> <div class="list"><!></div> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button></div>',1);function As(j,i){ms(i,!0);let u,g=e(void 0),m=e(void 0),v=e(c([])),d=e(void 0),f=e(void 0),E=e(0),N=e(0);function cs(l){l.type==="range.update"&&(p(E,c(l.start)),p(N,c(l.end)))}const C=new Array(1e4).fill(1).map((l,o)=>o);ns(()=>{p(d,void 0),p(f,c(t(m)))}),ns(()=>{p(f,void 0),p(d,c(t(g)))});let b=e(c(ws.AUTO)),_=e(c(xs.SMOOTH));function $(){let l=[];for(let o=0;o<1e4;(o+=1)-1)l.push(Math.random()*105+50);p(v,c(l))}$();var U=Os(),y=os(U),w=a(y),G=a(w),P=s(a(G));es(P),n(G),n(w);var x=s(w,2),F=a(x),K=s(a(F));es(K),n(F),n(x);var q=s(x,2),Q=a(q),T=s(a(Q)),k=a(T);k.value=(k.__value="auto")==null?"":"auto";var S=s(k);S.value=(S.__value="start")==null?"":"start";var O=s(S);O.value=(O.__value="center")==null?"":"center";var D=s(O);D.value=(D.__value="end")==null?"":"end",n(T),n(Q),n(q);var J=s(q,2),W=a(J),A=s(a(W)),I=a(A);I.value=(I.__value="auto")==null?"":"auto";var L=s(I);L.value=(L.__value="smooth")==null?"":"smooth";var X=s(L);X.value=(X.__value="instant")==null?"":"instant",n(A),n(W),n(J),n(y);var H=s(y,2),M=s(a(H),2),is=a(M);n(M);var Y=s(M,4),rs=a(Y);n(Y),n(H);var R=s(H,2),hs=a(R);vs(qs(hs,{height:500,width:"auto",model:C,get modelCount(){return C.length},get itemSize(){return t(v)},get scrollToIndex(){return t(d)},get scrollOffset(){return t(f)},get scrollToAlignment(){return t(b)},get scrollToBehaviour(){return t(_)},onVisibleRangeUpdate:cs,slot:(o,r)=>{let us=()=>r==null?void 0:r().style,as=()=>r==null?void 0:r().index;var h=Ss(),ds=a(h);n(h),ls(()=>{bs(h,"style",us()),_s(h,"highlighted",as()===t(d)),z(ds,`Item #${as()??""}`)}),V(o,h)},$$slots:{slot:!0}}),o=>u=o,()=>u),n(R);var Z=s(R,2),ss=a(Z);ss.__click=$;var js=s(ss,2);js.__click=[ks,v],n(Z),ls(()=>{z(is,t(E)),z(rs,t(N))}),ts(P,()=>t(g),l=>p(g,l)),ts(K,()=>t(m),l=>p(m,l)),ps(T,()=>t(b),l=>p(b,l)),ps(A,()=>t(_),l=>p(_,l)),V(j,U),fs()}gs(["click"]);const Is=`<script lang="ts">
  import {
    VirtualList,
    ALIGNMENT,
    SCROLL_BEHAVIOR,
...
`,Ls=`<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">lang</span>=<span class="hljs-string">&quot;ts&quot;</span>&gt;</span><span class="language-javascript">
  <span class="hljs-keyword">import</span> {
    <span class="hljs-title class_">VirtualList</span>,
    <span class="hljs-variable constant_">ALIGNMENT</span>,
    <span class="hljs-variable constant_">SCROLL_BEHAVIOR</span>,
    type <span class="hljs-title class_">SlotAttributes</span>
  } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;svelte-virtuallists&#x27;</span>;
...
`,Hs={code:Is,highlightedHTML:Ls,component:As};var Ms=B("<h2>Positioning</h2> <p>The component provides properties to position the list either on an element, or on a pixel offset.</p> <!>",1);function Es(j){var i=Ms(),u=s(os(i),4);ys(u,{example:Hs}),V(j,i)}export{Es as component,Bs as universal};
