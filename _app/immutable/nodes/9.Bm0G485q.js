import{p as y,J as f,j as _,h as i,l as g,t as T,k as j,m as h,r,K as m,y as I}from"../chunks/external.C8cba1ez.js";import{E as M}from"../chunks/ExampleArea.DYttOl7s.js";import{V as w}from"../chunks/svelte-virtuallists.BpvElS_U.js";var L=j("<thead><tr><th>Text</th><th>Index</th></tr></thead>"),V=j("<tr><td> </td><td> </td></tr>");function E(n,a){y(a,!1);const t=new Array(1e4).fill(1).map((u,l)=>({text:"ITEM "+l+" - Item "+l}));f(),w(n,{items:t,class:"list-table",style:"height:600px",isTable:!0,header:p=>{var s=L();i(p,s)},vl_slot:(p,s)=>{let x=()=>s==null?void 0:s().item,o=()=>s==null?void 0:s().index;var e=V(),c=h(e),b=h(c);r(c);var d=g(c),v=h(d);r(d),r(e),T(()=>{m(b,o()),m(v,`ITEM: ${o()??""} - ${x().text??""}`)}),i(p,e)},$$slots:{header:!0,vl_slot:!0}}),_()}const k=`<script lang="ts">
...
`,A={code:k,highlightedHTML:q,component:E};var C=j("<h2>Table rendering</h2> <!>",1);function z(n){var a=C(),t=g(I(a),2);M(t,{example:A}),i(n,a)}export{z as component};
