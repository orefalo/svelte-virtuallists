...
`,ks={code:Ss,highlightedHTML:As,component:Is};var Ls=C("<h2>Positioning</h2> <p>The component provides properties to position the list either on an element, or on a pixel offset.</p> <!>",1);function Cs(u){var o=Ls(),j=s(ps(o),4);_s(j,{example:ks}),R(u,o)}export{Cs as component,Rs as universal};
