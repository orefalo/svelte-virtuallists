import{p as h,J as m,h as j,t as u,f as e,j as i,w as d,y as g,K as v,q as y,m as x}from"../chunks/external.DepRz0zj.js";import{E as f}from"../chunks/ExampleArea.CqFsZ60u.js";import{V as _}from"../chunks/svelte-virtuallists.CXsgq9DL.js";var w=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function L(t,s){h(s,!1);const n=new Array(1e4).fill(1).map((r,a)=>({text:"ITEM "+a+" - Item "+a}));m(),_(t,{items:n,style:"width:100%",isHorizontal:!0,vl_slot:(a,l)=>{let o=()=>l==null?void 0:l().item;var p=w(),c=d(p);g(p),u(()=>v(c,o().text)),e(a,p)},$$slots:{vl_slot:!0}}),j()}const V=`<script lang="ts">
...
`,M={code:V,highlightedHTML:b,component:L};var S=i("<h2>Internal: VirtualList</h2> <!>",1);function E(t){var s=S(),n=y(x(s),2);f(n,{example:M}),e(t,s)}export{E as component};
