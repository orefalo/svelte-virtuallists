import{L as M,p as S,J as A,l as e,y as H,h as o,j as I,d as V,k as m,M as N,t as y,m as j,r as u,K as w,v as R,g as f,A as E}from"../chunks/external.CLekpqux.js";import{E as C}from"../chunks/ExampleArea.CPDYrG9L.js";import{V as z}from"../chunks/svelte-virtuallists.BU5kGoI3.js";function J(i,n){V(n,(l,c)=>25)}var K=m('<div style="border: 1px solid rgb(204, 204, 204)"> </div>'),T=m("<div> </div>"),B=m('<h2>Horizontal</h2> <!> <h2>Vertical</h2> <!> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button></div>',1);function D(i,n){S(n,!1);const l=new Array(1e4).fill(1).map((r,s)=>({text:"Item "+s+" item "+s,lineHeight:20+s%30+"px",width:20+s%30+"px"}));let c=N((r,s)=>25);function d(){V(c,(r,s)=>Math.round(Math.random()*125+30))}d(),A();var g=B(),v=e(H(g),2);z(v,{items:l,style:"width:100%",isHorizontal:!0,vl_slot:(s,a)=>{let h=()=>a==null?void 0:a().item;var p=K(),t=j(p);u(p),y(()=>w(t,h().text)),o(s,p)},$$slots:{vl_slot:!0}});var x=e(v,4);z(x,{items:l,style:"height:600px",vl_slot:(s,a)=>{let h=()=>a==null?void 0:a().item,p=()=>a==null?void 0:a().index;var t=T();const k=E(()=>`border: 1px solid rgb(204, 204, 204); line-height: ${f(c)(h(),p())??""}px;`);var L=j(t);u(t),y(()=>{R(t,"style",f(k)),w(L,h().text)}),o(s,t)},$$slots:{vl_slot:!0}});var b=e(x,2),_=j(b);_.__click=d;var q=e(_,2);q.__click=[J,c],u(b),o(i,g),I()}M(["click"]);const F=`<script lang="ts">
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`,O={code:F,highlightedHTML:G,component:D};var P=m("<h2>Variable Sizing</h2> <!>",1);function X(i){var n=P(),l=e(H(n),2);C(l,{example:O}),o(i,n)}export{X as component};
