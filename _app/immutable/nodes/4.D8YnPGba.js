...
`,S={code:V,highlightedHTML:b,component:L};var q=i("<h2>Horizontal List</h2> <!>",1);function z(t){var s=q(),n=y(x(s),2);f(n,{example:S}),e(t,s)}export{z as component};
