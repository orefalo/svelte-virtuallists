import{p as h,J as m,j,t as d,h as e,k as i,m as u,r as g,K as v,l as x,y}from"../chunks/external.bflEojmh.js";import{E as f}from"../chunks/ExampleArea.BuQoPj8o.js";import{V as w}from"../chunks/svelte-virtuallists.BsDTonD8.js";var _=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function L(t,s){h(s,!1);const n=new Array(1e4).fill(1).map((r,a)=>({text:"ITEM "+a+" - Item "+a}));m(),w(t,{items:n,style:"width:100%",isHorizontal:!0,vl_slot:(a,l)=>{let o=()=>l==null?void 0:l().item;var p=_(),c=u(p);g(p),d(()=>v(c,o().text)),e(a,p)},$$slots:{vl_slot:!0}}),j()}const V=`<script lang="ts">
