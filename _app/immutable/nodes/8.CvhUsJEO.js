import{p as g,J as d,t as i,g as r,h as b,w as c,e as y,x as h,K as f,B as v,y as x}from"../chunks/jdX24A6w.js";import{E as S}from"../chunks/OWgUB9v-.js";import{V as _}from"../chunks/B7HiuRcr.js";import{g as w}from"../chunks/BIpvo6ML.js";var k=i('<div class="slotStyle svelte-1iooypm"> </div>'),L=i('<div class="gradient myStyle svelte-1iooypm"><!></div>');function V(a,s){g(s,!1);const n=new Array(1e4).fill(1).map((m,t)=>({text:"#"+t+" "+w()}));d();var l=L(),o=c(l);_(o,{items:n,style:"height:600px",vl_slot:(t,p)=>{let j=()=>p==null?void 0:p().item;var e=k(),u=c(e,!0);h(e),y(()=>f(u,j().text)),r(t,e)},$$slots:{vl_slot:!0}}),h(l),r(a,l),b()}const q=`<script lang="ts">
...
`,R={code:q,highlightedHTML:M,component:V};var A=i("<h2>Vertical List</h2> <!>",1);function J(a){var s=A(),n=v(x(s),2);S(n,{example:R}),r(a,s)}export{J as component};
