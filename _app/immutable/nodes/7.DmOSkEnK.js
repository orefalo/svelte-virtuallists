import{L as C,p as R,t as o,B as t,y as L,w as j,s as H,g as i,h as A,q as M,n as _,e as b,x as d,m as S,K as w}from"../chunks/Hb09kDf2.js";import{E as F}from"../chunks/Be7KHuKK.js";import{V}from"../chunks/P-AzkfP4.js";import{g as E}from"../chunks/BIpvo6ML.js";function B(l,n){M(n,()=>25)}var K=o("<div> </div>"),N=o("<div> </div>"),T=o('<h2>Horizontal</h2> <!> <h2>Vertical</h2> <!> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button></div>',1);function D(l,n){R(n,!0);const p=new Array(1e4).fill(1).map(()=>({text:E()}));function g(){M(e,()=>Math.round(Math.random()*125+30))}let e=H(void 0);g();var v=T(),x=t(L(v),2);V(x,{items:p,style:"width:100%",isHorizontal:!0,get sizingCalculator(){return _(e)},vl_slot:(c,s)=>{let r=()=>s==null?void 0:s().index,h=()=>s==null?void 0:s().item,u=()=>s==null?void 0:s().size;var a=K(),m=j(a);d(a),b(()=>{S(a,"style",`border: 1px solid rgb(204, 204, 204); width: ${u()??""}px;`),w(m,`#${r()??""}
      ${h().text??""}`)}),i(c,a)},$$slots:{vl_slot:!0}});var y=t(x,4);V(y,{items:p,style:"height:600px",get sizingCalculator(){return _(e)},vl_slot:(c,s)=>{let r=()=>s==null?void 0:s().index,h=()=>s==null?void 0:s().item,u=()=>s==null?void 0:s().size;var a=N(),m=j(a);d(a),b(()=>{S(a,"style",`border: 1px solid rgb(204, 204, 204); line-height: ${u()??""}px;`),w(m,`#${r()??""}
      ${h().text??""}`)}),i(c,a)},$$slots:{vl_slot:!0}});var z=t(y,2),f=j(z);f.__click=g;var k=t(f,2);k.__click=[B,e],d(z),i(l,v),A()}C(["click"]);const G=`<script lang="ts">
