import{p as _,J as q,g as j,L as z,h,j as M,k as o,q as t,t as S,P as A,N as H,n as I,G as L,d as V,x as a,z as g}from"../chunks/external.BPpIJIx1.js";import{E as D}from"../chunks/ExampleArea.DwcMytTj.js";import{V as B}from"../chunks/svelte-virtuallists.ChZJuPxm.js";const C=!0,R=Object.freeze(Object.defineProperty({__proto__:null,prerender:C},Symbol.toStringTag,{value:"Module"}));var F=o('<div class="row svelte-11qjlwp"> </div>'),P=o('<div class="actions svelte-11qjlwp"><label for="item-height" class="svelte-11qjlwp">Item Height: <div class="range svelte-11qjlwp"><input type="range" id="item-height" step="5" min="50" max="155" class="svelte-11qjlwp"></div></label></div> <div class="list svelte-11qjlwp"><!></div>',1);function T(r,l){_(l,!1);const p=new Array(1e4).fill(1).map((i,s)=>({text:"Item "+s,lineHeight:20+s%20+"px",width:100+s%30+"px"}));let n=A(50);q();var e=P(),u=g(e),m=t(u),d=a(t(m)),b=t(d);H(b);var x=a(a(u,!0)),f=t(x);{var y=(i,s)=>{let v=()=>s==null?void 0:s().item,w=()=>s==null?void 0:s().style;var c=F(),k=t(c);S(()=>{I(c,"style",w()),L(k,v().text)}),h(i,c)};B(f,{model:p,height:500,width:"auto",get modelCount(){return p.length},get itemSize(){return j(n)},slot:y,$$legacy:!0})}z(b,()=>j(n),i=>V(n,i)),h(r,e),M()}const E=`<script lang="ts">
...
`,G={code:E,highlightedHTML:O,component:T};var J=o("<h2>List Positioning</h2> <p>The component provides properties to position the list either on an element, or on a pixel offset.</p> <!>",1);function U(r){var l=J(),p=g(l),n=a(a(p,!0)),e=a(a(n,!0));D(e,{example:G,$$legacy:!0}),h(r,l)}export{U as component,R as universal};
