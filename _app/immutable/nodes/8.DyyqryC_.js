import{p as h,H as m,h as j,t as g,f as e,j as i,x as u,z as d,I as y,r as v,n as x}from"../chunks/external.DHK_YTtL.js";import{E as f}from"../chunks/ExampleArea.D0HziaxS.js";import{V as _}from"../chunks/svelte-virtuallists.DIagZXNG.js";import{g as L}from"../chunks/sushi.BIpvo6ML.js";var S=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function V(a,s){h(s,!1);const t=new Array(1e4).fill(1).map((r,n)=>({text:"#"+n+" "+L()}));m(),_(a,{items:t,style:"height:600px",vl_slot:(n,l)=>{let o=()=>l==null?void 0:l().item;var p=S(),c=u(p);d(p),g(()=>y(c,o().text)),e(n,p)},$$slots:{vl_slot:!0}}),j()}const w=`<script lang="ts">
