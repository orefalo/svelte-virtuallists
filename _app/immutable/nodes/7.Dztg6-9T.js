...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`,J={code:D,highlightedHTML:G,component:B};var K=o("<h2>Variable Sizing</h2> <!>",1);function U(p){var n=K(),e=l(q(n),2);I(e,{example:J}),c(p,n)}export{U as component};
