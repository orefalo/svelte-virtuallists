import{p as h,H as m,h as j,t as g,f as e,j as i,x as d,z as u,I as x,r as y,n as v}from"../chunks/external.BW6pQqo1.js";import{E as f}from"../chunks/ExampleArea.D_dBPbyW.js";import{V as _}from"../chunks/svelte-virtuallists.CWEvJYjh.js";import{g as L}from"../chunks/sushi.BIpvo6ML.js";var S=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function V(a,s){h(s,!1);const t=new Array(1e4).fill(1).map((r,n)=>({text:"#"+n+" "+L()}));m(),_(a,{items:t,style:"height:600px",vl_slot:(n,l)=>{let o=()=>l==null?void 0:l().item;var p=S(),c=d(p);u(p),g(()=>x(c,o().text)),e(n,p)},$$slots:{vl_slot:!0}}),j()}const w=`<script lang="ts">
...
`,M={code:w,highlightedHTML:b,component:V};var k=i("<h2>Vertical List</h2> <!>",1);function H(a){var s=k(),t=y(v(s),2);f(t,{example:M}),e(a,s)}export{H as component};
