import{p as P,a as z,u as E,t as U,R as C,h as A,j as W,k as L,l as e,m as a,r as n,W as ns,v as D,g as s,K as O,C as F,y as G,e as ls,d as i,b as I,s as h,T as K,U as ts}from"../chunks/external.DZ8ltDyt.js";import{E as es}from"../chunks/ExampleArea.BJhje2p9.js";import{a as ps}from"../chunks/svelte-virtuallists.BtcFkJbB.js";const rs=!0,xs=Object.freeze(Object.defineProperty({__proto__:null,prerender:rs},Symbol.toStringTag,{value:"Module"}));var cs=L('<div class="container svelte-1cx9x18"><pre aria-hidden="true" class="svelte-1cx9x18"> </pre> <textarea readonly="" style="outline: none;" class="svelte-1cx9x18"></textarea></div>');function is(g,p){P(p,!0);let l=z(p,"value",7,""),w=z(p,"minRows",3,1),d=z(p,"maxRows",3,40);const _=j=>j.split(/\r?\n/);function S(j,b){const u=_(j);return u.length=b,u.reduce(function(T,q){return T+`
`+q})}E(()=>{l(S(l(),d()))});let k=F(()=>`${1+w()*1.2}em`),m=F(()=>d()?`${1+d()*1.2}em`:"auto");var o=cs(),r=a(o),f=a(r);n(r);var v=e(r,2);ns(v),n(o),U(()=>{D(r,"style",`min-height: ${s(k)??""}; max-height: ${s(m)??""}`),O(f,l()+`
...
`+s(l)),t.type==="range.update"&&(i(w,I(t.start)),i(d,I(t.end)))}const S=new Array(1e4).fill(1).map((t,x)=>x);let k,m=h(void 0),o=h(void 0),r=h(void 0),f=h(void 0);E(()=>{i(r,void 0),i(f,I(s(o)))}),E(()=>{i(f,void 0),i(r,I(s(m)))});var v=hs(),j=G(v);is(j,{get value(){return s(l)},minRows:4,maxRows:15});var b=e(j,2),u=a(b),M=a(u),T=e(a(M));K(T),n(M),n(u);var q=e(u,2),H=a(q),J=e(a(H));K(J),n(H),n(q),n(b);var V=e(b,2),R=e(a(V),2),Q=a(R);n(R);var N=e(R,4),X=a(N);n(N),n(V);var B=e(V,2),Y=a(B);ls(ps(Y,{height:500,width:"auto",model:S,get modelCount(){return S.length},itemSize:40,get scrollToIndex(){return s(r)},get scrollOffset(){return s(f)},onAfterScroll:_,onVisibleRangeUpdate:_,slot:(x,c)=>{let Z=()=>c==null?void 0:c().item,$=()=>c==null?void 0:c().style,ss=()=>c==null?void 0:c().index;var y=os(),as=a(y);n(y),U(()=>{D(y,"style",$()),ts(y,"highlighted",ss()===s(r)),O(as,`Item #${Z()??""}`)}),A(x,y)},$$slots:{slot:!0}}),x=>k=x,()=>k),n(B),U(()=>{O(Q,s(w)),O(X,s(d))}),C(T,()=>s(m),t=>i(m,t)),C(J,()=>s(o),t=>i(o,t)),A(g,v),W()}const js=`<script lang="ts">
