import{p as h,I as m,h as j,t as u,f as e,j as i,y as d,A as g,J as y,q as v,v as f}from"../chunks/external.DgMb7onD.js";import{E as x}from"../chunks/ExampleArea.g3WCh56v.js";import{V as _}from"../chunks/svelte-virtuallists.kv-RLIBA.js";import{g as w}from"../chunks/sushi.BIpvo6ML.js";var L=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function S(a,s){h(s,!1);const t=new Array(1e4).fill(1).map((r,n)=>({text:"#"+n+" "+w()}));m(),_(a,{items:t,style:"width:100%",isHorizontal:!0,vl_slot:(n,l)=>{let o=()=>l==null?void 0:l().item;var p=L(),c=d(p,!0);g(p),u(()=>y(c,o().text)),e(n,p)},$$slots:{vl_slot:!0}}),j()}const V=`<script lang="ts">
