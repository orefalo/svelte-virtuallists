import{p as P,a as z,u as E,t as H,O as U,h as A,j as Q,k as L,l as e,m as n,r as a,T as as,v as D,g as s,K as O,I as F,y as G,e as ls,d as i,b as I,s as h,Q as K,R as ts}from"../chunks/external.ClML6rh5.js";import{E as es}from"../chunks/ExampleArea.DqjhyFIj.js";import{V as ps}from"../chunks/svelte-virtuallists.Cbo0UehG.js";const rs=!0,xs=Object.freeze(Object.defineProperty({__proto__:null,prerender:rs},Symbol.toStringTag,{value:"Module"}));var cs=L('<div class="container svelte-1cx9x18"><pre aria-hidden="true" class="svelte-1cx9x18"> </pre> <textarea readonly="" style="outline: none;" class="svelte-1cx9x18"></textarea></div>');function is(g,p){P(p,!0);let l=z(p,"value",7,""),w=z(p,"minRows",3,1),d=z(p,"maxRows",3,40);const _=j=>j.split(/\r?\n/);function k(j,b){const u=_(j);return u.length=b,u.reduce(function(T,q){return T+`
`+q})}E(()=>{l(k(l(),d()))});let S=F(()=>`${1+w()*1.2}em`),m=F(()=>d()?`${1+d()*1.2}em`:"auto");var o=cs(),r=n(o),f=n(r);a(r);var v=e(r,2);as(v),a(o),H(()=>{D(r,"style",`min-height: ${s(S)??""}; max-height: ${s(m)??""}`),O(f,l()+`
`)}),U(v,l),A(g,o),Q()}var os=L('<div class="row svelte-ufwu3t"> </div>'),hs=L('<!> <div class="actions"><div class="select"><span>Scroll to row index <input id="index" type="number" placeholder="pick an index..." class="input"></span></div> <div class="select"><span>Scroll to pixel offset <input id="offset" type="number" placeholder="pick an offset..." class="input"></span></div></div> <div style="float: right;font-weight: bold"><span>Visible Area: start</span> <span> </span> - <span>end</span> <span> </span></div> <div class="list"><!></div>',1);function ds(g,p){P(p,!0);let l=h("// Event name: Event params   (Last event at the top)"),w=h(0),d=h(0);function _(t){i(l,JSON.stringify(t)+`
`+s(l)),t.type==="range.update"&&(i(w,I(t.start)),i(d,I(t.end)))}const k=new Array(1e4).fill(1).map((t,x)=>x);let S,m=h(void 0),o=h(void 0),r=h(void 0),f=h(void 0);E(()=>{i(r,void 0),i(f,I(s(o)))}),E(()=>{i(f,void 0),i(r,I(s(m)))});var v=hs(),j=G(v);is(j,{get value(){return s(l)},minRows:4,maxRows:15});var b=e(j,2),u=n(b),M=n(u),T=e(n(M));K(T),a(M),a(u);var q=e(u,2),C=n(q),J=e(n(C));K(J),a(C),a(q),a(b);var R=e(b,2),V=e(n(R),2),W=n(V);a(V);var N=e(V,4),X=n(N);a(N),a(R);var B=e(R,2),Y=n(B);ls(ps(Y,{height:500,width:"auto",model:k,get modelCount(){return k.length},itemSize:40,get scrollToIndex(){return s(r)},get scrollOffset(){return s(f)},onAfterScroll:_,onVisibleRangeUpdate:_,slot:(x,c)=>{let Z=()=>c==null?void 0:c().item,$=()=>c==null?void 0:c().style,ss=()=>c==null?void 0:c().index;var y=os(),ns=n(y);a(y),H(()=>{D(y,"style",$()),ts(y,"highlighted",ss()===s(r)),O(ns,`Item #${Z()??""}`)}),A(x,y)},$$slots:{slot:!0}}),x=>S=x,()=>S),a(B),H(()=>{O(W,s(w)),O(X,s(d))}),U(T,()=>s(m),t=>i(m,t)),U(J,()=>s(o),t=>i(o,t)),A(g,v),Q()}const js=`<script lang="ts">
