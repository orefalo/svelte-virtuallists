import{I as M,p as H,q as l,m as q,g as y,f as c,h as A,k,j as o,s as F,t as w,w as m,y as d,z as S,H as V}from"../chunks/external.DBvdoJEE.js";import{E as I}from"../chunks/ExampleArea.CVL16lgx.js";import{V as L}from"../chunks/svelte-virtuallists.x_EziPhy.js";function R(p,n){k(n,()=>25)}var E=o("<div> </div>"),N=o("<div> </div>"),T=o('<h2>Horizontal</h2> <!> <h2>Vertical</h2> <!> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button></div>',1);function B(p,n){H(n,!0);const e=new Array(1e4).fill(1).map((f,t)=>({text:"Item "+t}));function g(){k(i,()=>Math.round(Math.random()*125+30))}let i=F(void 0);g();var v=T(),x=l(q(v),2);L(x,{items:e,style:"width:100%",isHorizontal:!0,get sizingCalculator(){return y(i)},vl_slot:(t,s)=>{let r=()=>s==null?void 0:s().index,h=()=>s==null?void 0:s().item,u=()=>s==null?void 0:s().size;var a=E(),j=m(a);d(a),w(()=>{S(a,"style",`border: 1px solid rgb(204, 204, 204); width: ${u()??""}px;`),V(j,`#${r()??""}
      ${h().text??""}`)}),c(t,a)},$$slots:{vl_slot:!0}});var z=l(x,4);L(z,{items:e,style:"height:600px",get sizingCalculator(){return y(i)},vl_slot:(t,s)=>{let r=()=>s==null?void 0:s().index,h=()=>s==null?void 0:s().item,u=()=>s==null?void 0:s().size;var a=N(),j=m(a);d(a),w(()=>{S(a,"style",`border: 1px solid rgb(204, 204, 204); line-height: ${u()??""}px;`),V(j,`#${r()??""} Content:${h().text??""}`)}),c(t,a)},$$slots:{vl_slot:!0}});var b=l(z,2),_=m(b);_.__click=g;var C=l(_,2);C.__click=[R,i],d(b),c(p,v),A()}M(["click"]);const D=`<script lang="ts">
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
`,J={code:D,highlightedHTML:G,component:B};var K=o("<h2>Variable item Sizing</h2> <!>",1);function U(p){var n=K(),e=l(q(n),2);I(e,{example:J}),c(p,n)}export{U as component};
