import{p as h,J as m,j,t as d,h as e,k as i,m as g,r as u,K as v,l as x,y}from"../chunks/external.CMRhy-HJ.js";import{E as f}from"../chunks/ExampleArea.CjgkDF5f.js";import{V as _}from"../chunks/svelte-virtuallists.tt-sFMIm.js";var L=i('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function V(t,s){h(s,!1);const n=new Array(1e4).fill(1).map((r,a)=>({text:"ITEM "+a+" - Item "+a}));m(),_(t,{items:n,style:"height:600px",vl_slot:(a,l)=>{let c=()=>l==null?void 0:l().item;var p=L(),o=g(p);u(p),d(()=>v(o,c().text)),e(a,p)},$$slots:{vl_slot:!0}}),j()}const w=`<script lang="ts">
