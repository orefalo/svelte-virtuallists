import{L as q,p as H,l as p,y as L,h as i,j as M,d as S,k as o,s as A,t as w,m as u,r as d,v as f,K as z}from"../chunks/external.DZ8ltDyt.js";import{E as I}from"../chunks/ExampleArea.BJhje2p9.js";import{V}from"../chunks/svelte-virtuallists.BtcFkJbB.js";function N(e,t){S(t,(l,r)=>25)}var R=o("<div> </div>"),E=o("<div> </div>"),C=o('<h2>Horizontal</h2> <!> <h2>Vertical</h2> <!> <div class="actions"><button class="button">Randomize row heights</button> <button class="button">Same row heights</button></div>',1);function K(e,t){H(t,!0);const l=new Array(1e4).fill(1).map((c,n)=>({text:"Item "+n+" item "+n}));let r=A(void 0);function g(){S(r,(c,n)=>Math.round(Math.random()*125+30))}g();var v=C(),x=p(L(v),2);V(x,{items:l,style:"width:100%",isHorizontal:!0,vl_slot:(n,s)=>{let h=()=>s==null?void 0:s().item,m=()=>s==null?void 0:s().size;var a=R(),j=u(a);d(a),w(()=>{f(a,"style",`border: 1px solid rgb(204, 204, 204); width: ${m()??""}px;`),z(j,h().text)}),i(n,a)},$$slots:{vl_slot:!0}});var b=p(x,4);V(b,{items:l,style:"height:600px",vl_slot:(n,s)=>{let h=()=>s==null?void 0:s().item,m=()=>s==null?void 0:s().size;var a=E(),j=u(a);d(a),w(()=>{f(a,"style",`border: 1px solid rgb(204, 204, 204); line-height: ${m()??""}px;`),z(j,h().text)}),i(n,a)},$$slots:{vl_slot:!0}});var y=p(b,2),_=u(y);_.__click=g;var k=p(_,2);k.__click=[N,r],d(y),i(e,v),M()}q(["click"]);const T=`<script lang="ts">
