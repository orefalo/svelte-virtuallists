import{p as z,J as q,y,g as f,R as S,h as u,j as M,k as b,l as o,m as n,t as H,d as L,V as I,T as V,r as l,v as A,K as D}from"../chunks/external.DlXsjIqe.js";import{E as B}from"../chunks/ExampleArea.B4Ip24Dj.js";import{a as C}from"../chunks/svelte-virtuallists.To6s1RFa.js";const F=!0,U=Object.freeze(Object.defineProperty({__proto__:null,prerender:F},Symbol.toStringTag,{value:"Module"}));var T=b('<div class="row svelte-hvu9xx"> </div>'),E=b('<div class="actions svelte-hvu9xx"><label for="item-height" class="svelte-hvu9xx">Item Height: <div class="range svelte-hvu9xx"><input type="range" id="item-height" step="5" min="50" max="155" class="svelte-hvu9xx"></div></label></div> <div class="list svelte-hvu9xx"><!></div>',1);function O(i,t){z(t,!1);const p=new Array(1e4).fill(1).map((h,a)=>({text:"Item "+a,lineHeight:20+a%20+"px",width:100+a%30+"px"}));let r=I(50);q();var j=E(),c=y(j),g=n(c),m=o(n(g)),d=n(m);V(d),l(m),l(g),l(c);var x=o(c,2),v=n(x);C(v,{model:p,height:500,width:"auto",get modelCount(){return p.length},get itemSize(){return f(r)},slot:(a,s)=>{let w=()=>s==null?void 0:s().item,k=()=>s==null?void 0:s().style;var e=T(),_=n(e);l(e),H(()=>{A(e,"style",k()),D(_,w().text)}),u(a,e)},$$slots:{slot:!0}}),l(x),S(d,()=>f(r),h=>L(r,h)),u(i,j),M()}const P=`<script lang="ts">
...
`,K={code:P,highlightedHTML:J,component:O};var R=b("<h2>List Positioning</h2> <p>The component provides properties to position the list either on an element, or at a pixel offset.</p> <!>",1);function W(i){var t=R(),p=o(y(t),4);B(p,{example:K}),u(i,t)}export{W as component,U as universal};
