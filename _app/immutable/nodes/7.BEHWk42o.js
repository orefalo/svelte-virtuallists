...
`,A={code:q,highlightedHTML:k,component:V};var C=j("<h2>Table rendering</h2> <!>",1);function N(n){var a=C(),t=g(w(a),2);I(t,{example:A}),i(n,a)}export{N as component};
