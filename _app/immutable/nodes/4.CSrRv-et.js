import{p as h,H as m,h as j,t as u,f as i,j as e,x as d,z as g,I as y,r as v,n as f}from"../chunks/external.BW6pQqo1.js";import{E as x}from"../chunks/ExampleArea.D_dBPbyW.js";import{V as _}from"../chunks/svelte-virtuallists.CWEvJYjh.js";import{g as w}from"../chunks/sushi.BIpvo6ML.js";var L=e('<div style="border: 1px solid rgb(204, 204, 204)"> </div>');function S(a,s){h(s,!1);const t=new Array(1e4).fill(1).map((r,n)=>({text:"#"+n+" "+w()}));m(),_(a,{items:t,style:"width:100%",isHorizontal:!0,vl_slot:(n,l)=>{let o=()=>l==null?void 0:l().item;var p=L(),c=d(p);g(p),u(()=>y(c,o().text)),i(n,p)},$$slots:{vl_slot:!0}}),j()}const V=`<script lang="ts">
